        ...
        jobs?(<Box bg="white">
          <TableContainer p={'30px'}>
            ...
            <Box display={'flex'} justifyContent={'end'} pb={'10px'}>
              <Button  onClick={handleDeleteSelected}  colorScheme='teal' isDisabled={jobs.length === 0} w={{
                sm: '100px',
                md: '170px',
              }}> Delete Selected Jobs
              </Button>
              <Button onClick={handleDeleteAllJob} colorScheme='teal' isDisabled={jobs.length === 0}  marginX={"20px"} w={{
                sm: '100px',
                md: '150px',
